...
<form id="app-cover">
    ...
    <div id="options">
        ...
        <span class="opt-val">Websites</span>
        </div>
        <div class="option">
        ...
        <span class="opt-val">Aplicações</span>
        </div>
        <div class="option">
        ...
        <span class="label">Base de dados</span>
        <span class="opt-val">Base de dados</span>
        </div>
        <div class="option">
        ...
        <span class="opt-val">Currículos</span>
        </div>
        <div class="option">
        ...
        <span class="opt-val">Convites</span>
        </div>
